...
make -j 32 PETSC_DIR=$PWD PETSC_ARCH=arch-linux-c-opt all
make -j 32 PETSC_DIR=$PWD PETSC_ARCH=arch-linux-c-opt install
make -j 32 PETSC_DIR=$PWD/../petsc-build PETSC_ARCH="" check
